// Firefox end-to-end: spawn the lab server, wait for the REAL extension
// (already loaded in Firefox) to connect via its alarms-driven reconnect,
// then call snapshot/evaluate against the live browser.
// Run: node server/test/e2e-firefox.js   (needs the extension loaded; up to ~70s)
...
const server = spawn(process.execPath, [SERVER], {
  env: {
    ...
    BML_CONNECT_WAIT_MS: "45000",
    BML_QUIET: process.env.BML_QUIET ?? "0",
  },
